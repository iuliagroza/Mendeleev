...
(function($){
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            defaults = {
                checkAnswerText:  'Verifică',
                nextQuestionText: 'Următoarea &raquo;',
                backButtonText: '',
                completeQuizText: '',
                tryAgainText: '',
                questionCountText: 'Întrebarea %current din %total',
                preventUnansweredText: 'Trebuie să selectezi măcar o variantă.',
